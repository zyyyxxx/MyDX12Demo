...
// Compiled shader
#include <PreFilter_CS.h>

#include <Application.h>

#include <d3dx12.h>
PreFilterPSO::PreFilterPSO()
{
    ...
    CD3DX12_ROOT_PARAMETER1 rootParameters[PreFilterRS::NumRootParameters];
    rootParameters[PreFilterRS::PreFilterCB].InitAsConstants(sizeof(PreFilterCB) / 4, 0);
    rootParameters[PreFilterRS::SrcTexture].InitAsDescriptorTable(1, &srcMip);
    rootParameters[PreFilterRS::DstMips].InitAsDescriptorTable(1, &outMip);
    ...
    CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC rootSignatureDesc(PreFilterRS::NumRootParameters,
    ...
    pipelineStateStream.CS = { g_PreFilter_CS, sizeof(g_PreFilter_CS) };
