...
bool Demo2::LoadContent()
{
    ...
    commandList->LoadTextureFromFile(m_GraceCathedralTexture, L"F:/DX12Projects/MyDX12Demo/Assets/Textures/grace-new.hdr");
